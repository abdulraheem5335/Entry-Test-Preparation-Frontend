...
const streamSubjects = {
    "net-engineering": {
        ...
        description: "For Engineering & Computing programs",
        subjects: [
            {
                id: "mathematics",
                name: "Mathematics",
    ...
    "net-business-&-social-sciences": {
        ...
        description: "For BBA, Economics, LLB, and related programs",
        subjects: [
            {
    ...
    "net-architecture": {
        ...
        description: "For Architecture or Industrial Design programs",
        subjects: [
            {
                id: "design-aptitude",
    ...
    "net-natural-sciences": {
        ...
        description: "For BS Mathematics, Physics, or Chemistry programs",
        subjects: [
            {
                id: "mathematics",
                name: "Mathematics",
...
const SubjectSelection = () => {
    ...
    const streamData = streamSubjects[stream] || streamSubjects["net-engineering"];
                ...
                <div className="bg-white border-b border-slate-200">
                    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
                        ...
                        <nav className="mb-6 flex items-center gap-2 text-sm text-slate-500">
                            ...
                            <Link to="/net" className="hover:text-blue-600 transition">NET Preparation</Link>
                            <span className="text-slate-300">/</span>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                            ...
                            <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 min-w-[260px]">
                ...
                <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-between mb-8">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <select
                                ...
                                className="px-3 py-2 rounded-lg border border-slate-200 bg-white focus:ring-2 focus:ring-blue-500 focus:border-transparent transition cursor-pointer text-sm"
                            >
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {filteredSubjects.map((subject) => (
                            <article
                                key={subject.id}
                                className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:border-blue-300 hover:shadow-lg transition-all duration-300 group"
                            >
                                {/* Image Header */}
