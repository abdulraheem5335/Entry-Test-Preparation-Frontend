...
const natTests = [
	{
		title: "NAT-IE (Engineering)",
		description: "Prepare for engineering-related NAT subjects including Math, Physics, and Chemistry.",
		image: "https://source.unsplash.com/random/800x600/?engineering",
	},
	{
		title: "NAT-IM (Medical)",
		description: "Practice NAT medical subjects including Biology, Chemistry, and Physics.",
		image: "https://source.unsplash.com/random/800x600/?medical",
	},
	{
		title: "NAT-ICS (Computer Science)",
		description: "Prepare NAT computer science subjects including Math, Physics, and Computer Science.",
		image: "https://source.unsplash.com/random/800x600/?computer",
	},
	{
		title: "NAT-ICOM (Commerce)",
		description: "Commerce-related NAT subjects including Accounting, Economics, and Business Math.",
		image: "https://source.unsplash.com/random/800x600/?commerce",
	},
	{
		title: "NAT-IA (Arts)",
		description: "Prepare for NAT arts subjects such as English, General Knowledge, and Social Studies.",
		image: "https://source.unsplash.com/random/800x600/?arts",
	},
];
			...
			<main onClick={scroll(0,0)} className="min-h-screen bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 px-4 py-12 sm:px-6 lg:px-10">
				<section className="mx-auto grid max-w-6xl gap-12 rounded-[32px] bg-white/95 p-10 shadow-[0_40px_90px_rgba(15,23,42,0.08)] backdrop-blur-lg lg:grid-cols-[1.1fr_1fr] lg:p-14">
					<div className="flex flex-col gap-5">
						...
						<h1 className="text-4xl font-bold leading-tight text-slate-900 md:text-5xl">Prepare for NAT with Expert Roadmaps</h1>
						<p className="text-base text-slate-500 md:text-lg">
							Get guided study plans, realistic mocks, and actionable insights for every NAT test type.
						</p>
						<div className="mt-4 flex flex-wrap gap-4">
							...
							<Link to="/nat" className="inline-flex items-center justify-center rounded-full border border-slate-300/70 bg-white px-8 py-3 font-semibold text-slate-800 shadow-md transition hover:-translate-y-1 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-200">
								Explore All Tests
							</Link>
						</div>
					</div>
					<div className="relative flex items-center justify-center">
						...
						<img
							...
							alt="Students preparing for NAT"
				...
				<section className="mx-auto mt-6 max-w-6xl sm:mt-8 lg:mt-10">
					<header className="mx-auto max-w-3xl text-center">
						<h2 className="text-3xl font-bold text-slate-900 md:text-4xl">NAT Categories</h2>
						<p className="mt-4 text-base text-slate-500 md:text-lg">
							Select your NAT category and dive into focused prep with curated resources and practice modules.
						</p>
					</header>
					<div className="grid gap-8 sm:grid-cols-2 xl:grid-cols-3">
						{tests.map(({ title, description, image }) => (
							<article
								key={title}
